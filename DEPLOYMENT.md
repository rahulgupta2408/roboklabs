...
define('CONTACT_TO',     'info@roboklabs.com');            // ← your recipient address
...
3. You should see **✓ Message Sent!** and receive an email at the address you configured as `CONTACT_TO` (e.g. `info@roboklabs.com`).
